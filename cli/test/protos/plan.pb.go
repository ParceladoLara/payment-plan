...
type PlanParams struct {
	...
	MinInstallments                *uint32                `protobuf:"varint,14,opt,name=min_installments,json=minInstallments,proto3,oneof" json:"min_installments,omitempty"`
...
func (x *PlanParams) GetMinInstallments() uint32 {
	if x != nil && x.MinInstallments != nil {
		return *x.MinInstallments
	}
	return 0
}
...
const file_protos_plan_proto_rawDesc = "" +
	"\n" +
	"\x11protos/plan.proto\x12\tcli.types\"\xa1\x05\n" +
	"\n" +
	"PlanParams\x12)\n" +
	...
	"\"disbursement_only_on_business_days\x18\r \x01(\bR\x1edisbursementOnlyOnBusinessDays\x12.\n" +
	"\x10min_installments\x18\x0e \x01(\rH\x00R\x0fminInstallments\x88\x01\x01B\x13\n" +
	"\x11_min_installments\"\x9d\f\n" +
	"\fPlanResponse\x12 \n" +
...
func file_protos_plan_proto_init() {
	...
	file_protos_plan_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
