...
pub fn calculate_down_payment_plan(
    ...
    for i in 1..=params.installments {
        ...
        let plans = calculate_payment_plan(base_params)?;
...
mod down_payment_test {
    use crate::{calc::calculate_down_payment_plan, DownPaymentParams, Params};
    ...
    fn test_1_installment() {
        ...
        let result = calculate_down_payment_plan(params).unwrap();
