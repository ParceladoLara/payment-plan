...
pub fn prepare_calculation(params: Params) -> Vec<PreparedCalculation> {
    ...
    let divisor = Decimal::ONE + interest_rate;
    let base = Decimal::ONE / divisor;
    ...
    for i in 0..installments {
        ...
        let exponent = Decimal::from(accumulated_days) / dec!(30.0);
        let days_index = base.powd(exponent);
...
mod test {
    ...
    fn test_prepare_calculus_test_0() {
        let params = Params {
            ...
            min_installment_amount: dec!(0.0),
        ...
        assert!(prepared_calculations[0].days_index == dec!(0.9762833696137795));
        assert!(prepared_calculations[0].accumulated_days_index == dec!(0.9762833696137795));
        ...
        assert!(prepared_calculations[10].days_index == dec!(0.7703353931843917));
        assert!(prepared_calculations[10].accumulated_days_index == dec!(9.568877755632895));
        ...
        assert!(prepared_calculations[23].days_index == dec!(0.567796609395405));
        assert!(prepared_calculations[23].accumulated_days_index == dec!(18.10364842025564));
    }
    ...
    fn test_prepare_calculus_test_1() {
        ...
        assert!(prepared_calculations[0].days_index == dec!(0.9740050536866598));
        assert!(prepared_calculations[0].accumulated_days_index == dec!(0.9740050536866598));
        ...
        assert!(prepared_calculations[10].days_index == dec!(0.7583901916983443));
        assert!(prepared_calculations[10].accumulated_days_index == dec!(9.480262398672277));
        ...
        assert!(prepared_calculations[17].days_index == dec!(0.6359102146827685));
        assert!(prepared_calculations[17].accumulated_days_index == dec!(14.287911534617638));
    }
    ...
    fn test_prepare_calculus_test_2() {
        ...
        assert!(prepared_calculations[6].days_index == dec!(0.8473054985378986)); // 0.8473054985378985 is the expected value,see later
        assert!(prepared_calculations[6].accumulated_days_index == dec!(6.374065955281998));
        ...
        assert!(prepared_calculations[11].days_index == dec!(0.753814571370284));
        assert!(prepared_calculations[11].accumulated_days_index == dec!(10.322692327003178));
    }
    ...
    fn test_prepare_calculus_test_3() {
        ...
        assert!(prepared_calculations[0].days_index == dec!(0.9765625));
        assert!(prepared_calculations[0].accumulated_days_index == dec!(0.9765625));
        ...
        assert!(prepared_calculations[3].days_index == dec!(0.9080578343022551)); //908057834302255
        assert!(prepared_calculations[3].accumulated_days_index == dec!(3.7681276282380630)); //3.7681276282380627
        ...
        assert!(prepared_calculations[8].days_index == dec!(0.8046068596259314)); //8046068596259313
        assert!(prepared_calculations[8].accumulated_days_index == dec!(7.993043764995125));
    }
    ...
    fn test_prepare_calculus_test_4() {
        ...
        assert!(prepared_calculations[0].days_index == dec!(0.9777963563221375));
        assert!(prepared_calculations[0].accumulated_days_index == dec!(0.9777963563221375));
        ...
        assert!(prepared_calculations[3].days_index == dec!(0.9112732291360666));
        assert!(prepared_calculations[3].accumulated_days_index == dec!(3.7771034671078274));
        ...
        assert!(prepared_calculations[8].days_index == dec!(0.8094696914138441));
        assert!(prepared_calculations[8].accumulated_days_index == dec!(8.021906029443949));
    }
    ...
    fn test_prepare_calculus_test_5() {
        ...
        assert!(prepared_calculations[0].accumulated_days == 31);
        assert!(prepared_calculations[0].days_index == dec!(0.9651726351175118));
        assert!(prepared_calculations[0].accumulated_days_index == dec!(0.9651726351175118));
        ...
        assert!(prepared_calculations[10].days_index == dec!(0.6817649641421434));
        assert!(prepared_calculations[10].accumulated_days_index == dec!(8.967225722964963));
        ...
        assert!(prepared_calculations[23].days_index == dec!(0.43299148769124457)); // 0.4329914876912446
        assert!(prepared_calculations[23].accumulated_days_index == dec!(15.96509782080605));
    }
    ...
    fn test_prepare_calculus_test_6() {
        ...
        assert!(prepared_calculations[0].accumulated_days == 31);
        assert!(prepared_calculations[0].days_index == dec!(0.9748070746896711));
        assert!(prepared_calculations[0].accumulated_days_index == dec!(0.9748070746896711));
        ...
        assert!(prepared_calculations[6].accumulated_days == 214);
        assert!(prepared_calculations[6].days_index == dec!(0.8385000513504884)); // 0.8385000513504886
        assert!(prepared_calculations[6].accumulated_days_index == dec!(6.336263891503212));
        ...
        assert!(prepared_calculations[11].accumulated_days == 365);
        assert!(prepared_calculations[11].days_index == dec!(0.7405021169133975));
        assert!(prepared_calculations[11].accumulated_days_index == dec!(10.228570809330265));
        //10.228570809330268
    }
    ...
    fn test_prepare_calculus_test_7() {
        ...
        assert!(prepared_calculations[0].accumulated_days == 31);
        assert!(prepared_calculations[0].days_index == dec!(0.9650762734315015));
        assert!(prepared_calculations[0].accumulated_days_index == dec!(0.9650762734315015));
        ...
        assert!(prepared_calculations[3].accumulated_days == 122);
        assert!(prepared_calculations[3].days_index == dec!(0.8694459273639379));
        assert!(prepared_calculations[3].accumulated_days_index == dec!(3.6668395795122857));
        ...
        assert!(prepared_calculations[5].days_index == dec!(0.8097777779226664)); // 0.8097777779226665 is the expected value,see later
        assert!(prepared_calculations[5].accumulated_days_index == dec!(5.315698992965537));
    }
}
